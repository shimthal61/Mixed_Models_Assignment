...
There are only two theoretically sensible comparisons to make:

`Angry FaceExpression` with `Angry StoryEmotion` vs `Angry FaceExpression` with `Fear StoryEmotion`

`Fear FaceExpression` with `Fear StoryEmotion` vs `Fear FaceExpression` with `Angry StoryEmotion`
