...
Here we have a significant interaction between `StoryEmotion` and `FaceExpression`. How about in our Gamma model?

```{r}
summary(gamma_model)
```

The interaction between our two main effects is still present. 
