...
q2_data_tidied %>% 
  ...
  theme(plot.title = element_text(size = 35, hjust = 0.5, line = 0.5, face = "bold"),
      axis.title.x = element_text(size = 30),
      axis.title.y = element_text(size = 30, hjust = 1),
      text = element_text(family = "lato", size = 25)) +
  coord_flip()
```
...
q2_descriptives %>% 
  ...
  geom_text(size = 6.5, aes(label = label,
  ...
  theme_minimal() +
  theme(text = element_text(family = "lato", size = 26),
        plot.title = element_text(size = 30, hjust = 0.5, margin = margin(b = 35), face = "bold"),
        axis.title.x = element_text(size = 30, margin = margin(t = 30)),
        axis.title.y = element_text(size = 30, margin = margin(r = 30)),
        plot.margin = unit(rep(1.2, 4), "cm"))
```
