...
The interaction was interpreted by conducting Bonferroni-corrected pairwise comparisons. These comparisons revealed that the interaction was driven by Angry Face Expressions being processed faster in Angry vs. Fearful Story Emotions (1,864 ms. vs. 2,612 ms., t(898) = 4.47, *p*<.001). Fearful Face Expressions were also processed faster in Angry vs. Feaful Story Emotions (2,677 ms. vs. 2,037 ms., t(898)=6.43, *p*<.001).
