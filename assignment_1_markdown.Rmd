...
With a *p* < .001, it is clear that we have skewed residuals. 
...
I believe that the best approach is to build two models - one with and one without the outliers. If both results yield a similar narrative, then we can be confident that the effect is independent of the influential observations. Let's create a new dataset without the outliers.
