...
We built a mixed model to investigate the influence of Item Context (Neutral vs. Negative vs. Positive) on Reaction Time. After finding that our model violated normality assumptions, we build 2 new models. One of them modeled our data using the Gamma distribution, the other modeled our data which excluded the outliers. All three of our models revealed the same significant effects. As such, we decided to continue with our original model.

Post hoc comparisons applying Tukey correction confirmed that words appearing in Negative contexts resulted in significantly faster response times than words appearing in Positive contexts (*p* < .001), but not Neutral contexts (*p* = .089). The difference in response times given for words in Neutral contexts and Positive Contexts was not statistically significant (*p* = .264.
